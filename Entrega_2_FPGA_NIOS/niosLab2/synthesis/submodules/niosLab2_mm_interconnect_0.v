...
module niosLab2_mm_interconnect_0 (
		...
		input  wire        pio_motor_reset_reset_bridge_in_reset_reset,    //    pio_motor_reset_reset_bridge_in_reset.reset
	...
	wire  [92:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> pio_motor_s1_agent:cp_data
	...
	wire  [16:0] pio_switches_s1_agent_m0_address;                                                   // pio_switches_s1_agent:m0_address -> pio_switches_s1_translator:uav_address
	...
	wire  [93:0] pio_switches_s1_agent_rf_source_data;                                               // pio_switches_s1_agent:rf_source_data -> pio_switches_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] pio_switches_s1_agent_rsp_fifo_out_data;                                            // pio_switches_s1_agent_rsp_fifo:out_data -> pio_switches_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> pio_switches_s1_agent:cp_data
	...
	wire  [92:0] pio_motor_s1_agent_rp_data;                                                         // pio_motor_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [92:0] pio_switches_s1_agent_rp_data;                                                      // pio_switches_s1_agent:rp_data -> router_007:sink_data
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                               //                      clk.clk
		.reset                  (pio_motor_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                 //             clk.clk
		.reset                   (pio_motor_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
	...
	niosLab2_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                               // in_clk_0.clk
		.in_rst_0_reset (pio_motor_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
