...
# ACDS 18.1 625 linux 2020.11.29.19:07:32
# ----------------------------------------
...
ensure_lib                                              ./libraries/pio_motor                                   
vmap       pio_motor                                    ./libraries/pio_motor                                   
ensure_lib                                              ./libraries/peripheral_LED                              
vmap       peripheral_LED                               ./libraries/peripheral_LED                              
...
alias com {
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/niosLab2_pio_motor.vhd"                                          -work pio_motor                                   
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/peripheral_LED.vhd"                                              -work peripheral_LED                              
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/niosLab2_PIO_SWITCHES.vhd"                                       -work PIO_SWITCHES                                
