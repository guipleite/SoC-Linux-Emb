...
mkdir -p ./libraries/pio_motor/
mkdir -p ./libraries/peripheral_LED/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/niosLab2_pio_motor.vhd"                                          -work pio_motor                                    -cdslib ./cds_libs/pio_motor.cds.lib                                   
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/peripheral_LED.vhd"                                              -work peripheral_LED                               -cdslib ./cds_libs/peripheral_LED.cds.lib                              
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/niosLab2_PIO_SWITCHES.vhd"                                       -work PIO_SWITCHES                                 -cdslib ./cds_libs/PIO_SWITCHES.cds.lib                                
